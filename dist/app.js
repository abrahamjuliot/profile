...
var _ensc = require('../data/ensc.js');

var _ensc2 = _interopRequireDefault(_ensc);

var _geo = require('../data/geo.js');
	...
	var onload = function onload(req, fn) {
		...
		req.onload = function () {
			if (req.status >= 200 && req.status < 400) {
				var _data = req.responseText;parse && (_data = JSON.parse(_data));
				fn(_data); // execute callback with data
			}
		};
	};
	return {
...
var site = siteURL == 'ensc' ? 'rcwecm1171' : siteURL == 'geo' ? 'rcwecm4841' : '';
...
var json = siteURL == 'geo' ? _geo2.default : _ensc2.default;
...
},{"../data/ensc.js":1,"../data/geo.js":2,"./template.js":4}],4:[function(require,module,exports){
'use strict';
